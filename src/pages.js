...
async function pageStudy(req, res){
    ...
    if (!filters.subject || !filters.weekday || !filters.time) {
        return res.render(__dirname + "/study.html", {filters, subjects, weekdays})
    }
...
`
    ...
    try {
        ...
        return res.render(__dirname + "/study", {proffys, subjects, filters, weekdays})
